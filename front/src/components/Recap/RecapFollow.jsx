...
export default function RecapFollow(props) {
    ...
    return (
      <>
    <div className={classes["recap-container"] + " " + classes["recap-user"]} style={{ backgroundColor: props.indice % 2 === 0 ? "rgb(210,210,210)" : ""}}>
        ...
        {props.addButton && 
            <div className={classes["recap-button"]}>
                <Icon
                        ...
                        handleClick={() => {moveToUser()}}
                    />
                {
                    props.user.id != props.follower.id && (add ? (
                        <Icon
                        icon={icon}
                        iconClicked={icon}
                        hoverColor="icon-will-be-blue"
