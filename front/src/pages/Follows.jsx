      ...
      {isLoading ? (
        ...
        <div className={classes["container_body"]}>
          ...
          <div className={classes["container_body_center"]} style={{marginTop: '2rem'}}>
            ...
            {data.follow && data.follow.map((item, key) =>
              <RecapFollow user={item} follower={data.userConnected} indice={key} addButton={true} isFollow={data.followMeData.some(followMeData => followMeData.id === item.id)}/>
                  )}
          </div>
